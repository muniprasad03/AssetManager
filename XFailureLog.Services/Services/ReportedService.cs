...
namespace AssetManager.Services
{
    public class ReportedService : ServiceBase, IReportedService
    {
          ...
          public ReportedService(IRequestContext requestContext, XWorkDB db)
            : base(requestContext)
        {
            this.DB = db;
        }
        ...
        {
            return this.DB.Fetch<Data.Model.Department>("Select * from Department").MapCollectionTo<Data.Model.Department, AssetManager.Models.Department>().ToList();
        }
