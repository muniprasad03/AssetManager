    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var loginActivity = new LoginActivity()
            {
                ...
                LoginIPAddress = this.GetIPAddress(),
        ...
        {
            var loginActivity = new LoginActivity() { LoginIPAddress = this.GetIPAddress(), LoginTime = DateTime.UtcNow, LoginStatus = LoginStatus.LogOut };
            this.userService.SaveLoginActivity(loginActivity);
